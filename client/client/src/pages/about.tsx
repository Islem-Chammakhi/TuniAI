          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <p className="text-dark-brown/80 mb-4">
                  Founded in 2023 by a team of technologists, historians, and cultural preservationists, TunisiaAI combines cutting-edge artificial intelligence with deep cultural knowledge to create a unique platform for monument identification and education.
                </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 mt-8">
                ...
                <p className="text-dark-brown/80 mb-4">
                  At the heart of TunisiaAI is our proprietary monument recognition system. Using advanced computer vision and machine learning algorithms, our technology can identify Tunisian monuments from user photos with remarkable accuracy.
                </p>
                <p className="text-dark-brown/80 mb-4">
                  The TunisiaAI system has been trained on thousands of images of monuments from different angles, lighting conditions, and states of preservation, allowing it to recognize structures even from partial views or unusual perspectives.
                </p>
                <p className="text-dark-brown/80">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-brown/80">
                        We believe that understanding leads to appreciation, and appreciation leads to preservation. By educating visitors about Tunisia's monuments, we hope to inspire a deep respect for these irreplaceable treasures.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-brown/80">
                        We're committed to making Tunisia's rich cultural heritage accessible to everyone, regardless of background or expertise. Our platform provides information in multiple languages and at varying levels of detail.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-brown/80">
                        By highlighting lesser-known monuments and providing practical visitor information, we aim to encourage tourism across all regions of Tunisia, supporting local economies and communities.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-brown/80">
                        Through our user-contributed photos and ongoing research, we're creating a comprehensive digital archive of Tunisia's monuments, preserving them for future generations.
                      </p>
                    </div>
                  </div>
                </div>
